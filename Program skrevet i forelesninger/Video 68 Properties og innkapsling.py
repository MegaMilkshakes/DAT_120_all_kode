# -*- coding: utf-8 -*-
"""
Created on Sat Oct 16 20:09:56 2021
...
class Punkt:  #start med stor bokstav, skiller klasse fra funksjoner og variabler
    ...
    #kontroll for at taller er lovlig, ikke negativt i dette tilfelle
    @x_koordinat.setter
    def x_koordinat(self, ny_verdi):
        if ny_verdi < 0:
            raise ValueError("Punktet kan ikke ha negativ x_koordinat!")
